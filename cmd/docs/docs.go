                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/response.CategoryResponseDto"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CategoryRequestDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "models.Category": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Categoría de pantalones de vestir y casual"
                },
                "id": {
                    "type": "string",
                    "example": "67791e1d1b8af760b0149bb5"
                },
                "name": {
                    "type": "string",
                    "example": "Pantalones"
